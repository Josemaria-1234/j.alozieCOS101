fn main() {
    ...
    //Array with data type (explicit integer datatypes)
    ...
    //Array with default values that values that creates and
    //initiatizes all its elements with a default value of -1
    let arr3:[i32;8] = [-1;8];
    println!("\nArray with data type");
